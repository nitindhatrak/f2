angular.module('feedbackCtrl', ['feedbackService', 'userService'])
	...
	.controller('FeedbackController', function($rootScope,Feedback, socketio, Auth, User) {
		...
		var vm = this;
		vm.doShowFeedback = false;

		vm.showView = function(viewId){
			if(viewId == 1){
				document.getElementById("homeScreen").setAttribute("class", "active");
				document.getElementById("feedbackScreen").setAttribute("class", "");
				vm.doShowFeedback = false;
			}
			else{
				document.getElementById("homeScreen").setAttribute("class", "");
				document.getElementById("feedbackScreen").setAttribute("class", "active");	
				vm.doShowFeedback = true;
			}
		}
